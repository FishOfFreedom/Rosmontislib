...
import com.freefish.rosmontislib.gui.animation.Animation;
...
import com.freefish.rosmontislib.gui.modular.WidgetUIAccess;
...
public class Widget {
    ...
    public boolean isRemote() {
        return (gui != null && gui.holder != null) ? gui.holder.isRemote() : RosmontisLib.isRemote();
    }
