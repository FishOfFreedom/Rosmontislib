...
import com.freefish.rosmontislib.mixin.accessor.SlotAccessor;
import com.freefish.rosmontislib.utils.CycleItemStackHandler;
import com.freefish.rosmontislib.utils.IItemTransfer;
import com.freefish.rosmontislib.utils.ItemStackTransfer;
import com.freefish.rosmontislib.utils.TagOrCycleItemStackTransfer;
...
public class SlotWidget extends Widget implements IRecipeIngredientSlot, IConfigurableWidget {
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        if (isMouseOverElement(mouseX, mouseY) && gui != null) {
            ...
            return (canPutItems || canTakeItems);
        }
        return false;
    }
