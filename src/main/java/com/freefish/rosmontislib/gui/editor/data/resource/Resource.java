    ...
    public T removeStaticResource(File file) {
        ...
        if (file.isFile() && file.exists()) {
            try {
                ...
                RosmontisLib.LOGGER.error("Failed to delete static resource file {} from {}: ", file, this, e);
            }
        }
    ...
    public void addStaticResource(File file, T resource) {
        if (supportStaticResource()) {
            ...
            try {
                ...
                RosmontisLib.LOGGER.error("Failed to save static resource file {} from {}: ", file, this, e);
            }
        }
    }
