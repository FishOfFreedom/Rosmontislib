package com.freefish.rosmontislib.client.shader.postprocessing;

import com.freefish.rosmontislib.RosmontisLib;
import com.freefish.rosmontislib.client.shader.rendertarget.CopyDepthColorTarget;
import com.freefish.rosmontislib.client.shader.rendertarget.ProxyTarget;
...
public class PostProcessing implements ResourceManagerReloadListener {
    ...
    public static final PostProcessing BLOOM_UNREAL = new PostProcessing("bloom_unreal", new ResourceLocation(RosmontisLib.MOD_ID, "shaders/post/bloom_unreal.json"));
    ...
    public void renderPost(@NotNull PostChain postChain, RenderTarget post, RenderTarget output) {
        RenderTarget target = postChain.getTempTarget("rosmontislib:input");
        ...
        RenderUtils.fastBlit(postChain.getTempTarget("rosmontislib:output"), output);
