...
public class TileParticle implements IParticle {
    ...
    protected RLParticleConfig config;
    ...
    public TileParticle(IParticleEmitter emitter, RLParticleConfig config, RandomSource randomSource) {
    ...
    public Matrix4f getSpaceTransform() {
        return config.getSimulationSpace() == RLParticleConfig.Space.Local ?
...
u     */
    ...
    public Vector3f getInternalVelocity() {
        ...
        if (config.forceOverLifetime.isEnable() && config.forceOverLifetime.getSimulationSpace() == RLParticleConfig.Space.Local) {
    ...
    public Vector3f getRealVelocity() {
        ...
        if (config.forceOverLifetime.isEnable() && config.forceOverLifetime.getSimulationSpace() == RLParticleConfig.Space.World) {
            velocity.add(config.forceOverLifetime.getForce(this));
        }
